...
#define REDBUTTON 19
#define BUTTONMOVEVALUE 10 // how much to move for a button press
...
#define LY_MIC 8
#define LY_STEPS_REV 200
#define LY_STEPS_SLOW_REV LY_STEPS_REV/8
#define RPM 120
...
*/
		...
		position = position+(stepsize/LY_MIC);
